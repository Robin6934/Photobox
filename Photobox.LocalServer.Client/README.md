# Photobox.LocalServer.RestApi - the C# library for the Photobox.LocalServer
...
```
nuget pack -Build -OutputDirectory out Photobox.LocalServer.RestApi.csproj
```
...
------------ | ------------- | ------------- | -------------
*ApplicationApi* | [**ApiApplicationShutDownGet**](docs/ApplicationApi.md#apiapplicationshutdownget) | **GET** /api/Application/ShutDown | 
