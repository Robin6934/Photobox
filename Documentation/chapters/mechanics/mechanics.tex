...
zugeschnitten werden. In der Abbildung \autoref{fig:zuschnitt} ist der grobe 
Zuschnitt der Platten auf der Kreissäge zu sehen.

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.75\textwidth]{zuschnitt.JPG}
...
für den Blitz und den Laptop gefräst.
