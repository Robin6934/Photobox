namespace EOSDigital.SDK
{
    ...
    /// <returns></returns>
    public delegate ErrorCode SDKProgressCallback(
        int inPercent,
        IntPtr inContext,
        ref bool outCancel
    );
    ...
    public delegate ErrorCode SDKPropertyEventHandler(
    ...
    /// <param name="inContext">A reference to the object that has sent the event</param>
    /// <returns>Any of the SDK errors</returns>
    public delegate ErrorCode SDKObjectEventHandler(
    ...
    /// <param name="inContext">A reference to the object that has sent the event</param>
    /// <returns>Any of the SDK errors</returns>
    public delegate ErrorCode SDKStateEventHandler(
