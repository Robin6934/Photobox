...
> void ApiImageGetImageImageNameGet (string imageName)
...
namespace Example
{
    public class ApiImageGetImageImageNameGetExample
    {
        public static void Main()
        {
            ...
            try
            {
                apiInstance.ApiImageGetImageImageNameGet(imageName);
            }
            catch (ApiException  e)
            {
...
try
{
    apiInstance.ApiImageGetImageImageNameGetWithHttpInfo(imageName);
}
catch (ApiException e)
{
